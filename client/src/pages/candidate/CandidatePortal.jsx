          ...
          <div className="bg-yellow-50  border border-yellow-200  rounded-lg p-4 mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <a
                ...
                className="inline-flex items-center  hover: font-medium"
              >
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200  p-6 mb-8">
          ...
          <div className="space-y-6">
            {candidate.interviews.map((interview, idx) => (
              <div key={interview._id} className="bg-gray-50rounded-lg p-6 border border-gray-200 ">
                {/* Interview Header */}
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    <h4 className="text-lg font-semibold text-gray-900 ">Interview #{idx + 1}</h4>
                    {interview.result && ['Selected', 'Rejected', 'Shortlisted'].includes(candidate.status) && (
                      <span className={`ml-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${interview.result === 'Passed' ? 'bg-green-100  text-green-800 ' :
                        interview.result === 'Failed' ? 'bg-red-100  text-red-800 ' :
                          interview.result === 'No Show' ? 'bg-gray-100  text-gray-800 ' :
                            interview.result === 'Taken' ? 'bg-blue-100  text-blue-800 ' :
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    <span className="text-sm font-medium text-gray-500 ">Scheduled Date & Time</span>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900  font-medium">{interview.location}</p>
                  </div>

                  {/* {interview.interviewer && (
                      <div>
                        <span className="text-sm font-medium text-gray-500 ">Interviewer</span>
                        <p className="text-gray-900  font-medium">{interview.interviewer.name}</p>
                      </div>
                    )} */}
                  ...
                  <div className="mb-4">
                    <span className="text-sm font-medium text-gray-500 ">Interview Status</span>
                    <div className="mt-1">
                      {interview.result ? (
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${interview.result === 'Pending' ? 'bg-yellow-100  text-yellow-800 ' :
                          interview.result === 'Taken' ? 'bg-blue-100  text-blue-800 ' :
                  ...
                  <div className="mb-4 p-3 bg-blue-50  rounded-lg border border-blue-200 ">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-blue-600  mt-1">Click to join the online interview</p>
                      </div>
                      <a
                ...
                {['Selected', 'Rejected', 'Shortlisted'].includes(candidate.status) && interview.feedback && (
                  <div className="mb-4">
                    <span className="text-sm font-medium text-gray-500 ">Interview Feedback</span>
                    <div className="mt-2 p-3 bg-yellow-50  rounded-lg border border-yellow-200 ">
                      <p className="text-gray-900  text-sm leading-relaxed">{interview.feedback}</p>
                    </div>
                  </div>
                )}
